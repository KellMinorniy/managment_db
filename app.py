...
login_manager.login_message = 'Необходимо пройти авторизацию'
...
def edit_user(user_id):
    ...
    if request.method == "POST":
        ...
        try:
            ...
            flash("Пользователь обновлен успешно", category="success")
            return redirect(url_for('index'))
        except DatabaseError as error:
            flash(
...
def auth():
    ...
    if user:
        ...
        flash('Вы успешно авторизованы', category='success')
